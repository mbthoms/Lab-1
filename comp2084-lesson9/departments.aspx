...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <a href="department-details.aspx" class="btn btn-primary">Add Department</a>

    <asp:GridView runat="server" ID="grdDepartments" CssClass="table table-striped table-hover" AutoGenerateColumns="false" AllowPaging="true" PageSize="2" OnPageIndexChanging="grdDepartments_PageIndexChanging" OnRowDeleting="grdDepartments_RowDeleting" DataKeyNames="DepartmentID">
        <Columns>
            ...
            <asp:HyperLinkField HeaderText="Edit" Text="Edit" DataNavigateUrlFields="DepartmentID"
                 DataNavigateUrlFormatString="department-details.aspx?DepartmentID={0}" ControlStyle-CssClass="btn btn-default"/>
